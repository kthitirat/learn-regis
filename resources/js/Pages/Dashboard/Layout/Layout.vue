<template>
    <div>
        <nav class="bg-[#c9252d] fixed top-0 z-30 w-full">
            <div class="navbar relative">
                <div class="flex-1">
                    <a class="btn btn-ghost text-xl">ARU TEST</a>
        ...
        <!-- <div class="pl-80 pt-16"> อันเดิม-->
        <!-- <div class="pl-20 pt-12">
            <div class="px-8 py-8 pl-80 overscroll-y-auto"> -->
